...
class TestModuleRecommendationResponseWeapon(unittest.TestCase):
    """ModuleRecommendationResponseWeapon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModuleRecommendationResponseWeapon:
        """Test ModuleRecommendationResponseWeapon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModuleRecommendationResponseWeapon`
        """
        model = ModuleRecommendationResponseWeapon()
        if include_optional:
            return ModuleRecommendationResponseWeapon(
                weapon_id = '',
                recommendation = [
    ...
    def testModuleRecommendationResponseWeapon(self):
        """Test ModuleRecommendationResponseWeapon"""
