...
class ModuleRecommendationResponseDescendant(BaseModel):
    """
    ModuleRecommendationResponseDescendant
    """ # noqa: E501
    descendant_id: Optional[StrictStr] = Field(default=None, description="Descendant identifier (Refer to /meta/descendant API)")
    recommendation: Optional[List[ModuleRecommendationResponseDescendantRecommendationInner]] = Field(default=None, description="Descendant Recommendation information")
    __properties: ClassVar[List[str]] = ["descendant_id", "recommendation"]
