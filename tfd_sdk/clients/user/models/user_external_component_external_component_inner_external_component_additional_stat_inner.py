...
class UserExternalComponentExternalComponentInnerExternalComponentAdditionalStatInner(BaseModel):
    """
    UserExternalComponentExternalComponentInnerExternalComponentAdditionalStatInner
    """ # noqa: E501
    additional_stat_name: Optional[StrictStr] = Field(default=None, description="External component random option name")
    additional_stat_value: Optional[StrictStr] = Field(default=None, description="External component random option value")
