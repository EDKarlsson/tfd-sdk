...
class UserReactorReactorAdditionalStatInner(BaseModel):
    """
    UserReactorReactorAdditionalStatInner
    """ # noqa: E501
    additional_stat_name: Optional[StrictStr] = Field(default=None, description="Reactor random option name")
    additional_stat_value: Optional[StrictStr] = Field(default=None, description="Reactor random option value")
